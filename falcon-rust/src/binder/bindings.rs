...
fn bindgen_test_layout_shake256_context() {
    const UNINIT: ::std::mem::MaybeUninit<shake256_context> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).opaque_contents) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
...
extern "C" {
    pub fn falcon_get_logn(obj: *mut ::std::os::raw::c_void, len: usize) -> ::std::os::raw::c_int;
}
extern "C" {
